...
VALUES 
  ('Relax și Spa', 'spa-si-relaxare', 'Experiențe de relaxare, spa și wellness'),
  ('Gourmet', 'gastronomie', 'Degustări de vinuri, cursuri de gătit și experiențe culinare'),
  ('Adrenalină și Sport', 'aventura-si-sport', 'Sporturi extreme, zboruri și aventuri pline de adrenalină'),
