  ...
  return (
    <>
      ...
      <motion.button
        ...
        className={`fixed bottom-4 right-4 md:bottom-6 md:right-6 z-50 w-12 h-12 md:w-16 md:h-16 rounded-full bg-primary text-primary-foreground shadow-lg hover:shadow-xl flex items-center justify-center transition-all duration-300 ${isOpen ? "scale-0" : "scale-100"}`}
      >
