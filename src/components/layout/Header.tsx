...
import { Menu, X, Search, Heart, ShoppingBag, User, LogOut, Shield, Gift, Handshake, Truck, Award, BookOpen, Bell, Building2 } from "lucide-react";
      ...
      <div className="container">
        <div className="flex items-center justify-between h-14 sm:h-16 lg:h-20">
          ...
          <nav className="hidden lg:flex items-center gap-6">
            ...
            <Link
              to="/corporate"
              className="text-muted-foreground hover:text-foreground font-medium transition-colors duration-200 relative group flex items-center gap-1.5"
            >
